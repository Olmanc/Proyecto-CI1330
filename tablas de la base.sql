...
ALTER TABLE USUARIOS
	ADD	APELLIDO1 CHAR(20)

ALTER TABLE USUARIOS
	ADD	APELLIDO2 CHAR(20)

ALTER TABLE USUARIOS
	ALTER COLUMN APELLIDO1 VARCHAR(20)

ALTER TABLE USUARIOS
	ALTER COLUMN APELLIDO2 VARCHAR(20)

ALTER TABLE TELEFONOS
	ALTER COLUMN NUMERO CHAR(8)

alter table Maneja
add constraint manejaPk primary key (ROL_ID, PERMISO_ID)

ALTER TABLE USUARIOS
ADD ID_ASP NVARCHAR(128)

ALTER TABLE USUARIOS
ADD CONSTRAINT ID_ASP_USERS_FK FOREIGN KEY (ID_ASP) REFERENCES AspNetUsers (Id)
